...
MainWindow::MainWindow(QWidget *parent)
    ...
    // 🌟 UI Modern Styling (safe, no changes to .ui file)
...
void MainWindow::setupConnections() {
    ...
    connect(ui->sourceComboBox, QOverload<int>::of(&QComboBox::currentIndexChanged),
            this, &MainWindow::handleSourceSelection);
    connect(ui->startButton, &QPushButton::clicked, this, [=]() {
        ...
        } else if (index == 2) { // Browse File
            openVideoFile();
            return; // handled inside openVideoFile
        } else {
        ...
        timer->start(30);
        ui->statusLabel->setText("✨Status : Playing");
    });
...
void MainWindow::updateFrame() {
    ...
    *capture >> frame;
    ...
    detectAndDrawFaces(frame, false);
...
void MainWindow::captureFrame() {
    ...
    for (const auto &face : faces) {
        showThumbnail(face);  // Make sure showThumbnail() is defined and working
    }
